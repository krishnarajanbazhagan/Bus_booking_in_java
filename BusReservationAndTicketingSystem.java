    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)vilupuram | 500 |   "+available[1]+"   **");
    					System.out.println("** 2.) | trichy | 700|  "+available[2]+"   **");
    					System.out.println("** 3.)mdurai  | 850 |   "+available[3]+"   **");
    					System.out.println("** 4.)nagarkoil      | 1200 |   "+available[4]+"   **");
    					System.out.println("** 5.)kanyakumari     | 1250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					System.out.println("**   DESTINATION   |  FARE  |  SEAT  **");
    					System.out.println("***************************************");
    					System.out.println("** 1.)viluppuram   | 500 |   "+available[1]+"   **");
    					System.out.println("** 2.)trichy  | 700 |   "+available[2]+"   **");
    					System.out.println("** 3.)madurai   | 850 |   "+available[3]+"   **");
    					System.out.println("** 4.)nagarkoil      | 1200 |   "+available[4]+"   **");
    					System.out.println("** 5.)kanyakumari     | 1250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
    					...
    					String dest[] = { " ", "trichyy", "vilupuram", "madurai", "nagarkoil", "kanyakumari"};
